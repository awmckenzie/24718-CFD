...
def ADI(dx, dy, dt, Lx, Ly, t, T_0y, T_Lxy, T_x0, T_xLy_arr, T_0, a, TDMA=False):
    ...
    for i in range(int(t/dt)):
        ...
        By[0] += p*T_x0
        By[y_int_nodes-1] += p*T_xLy_arr[i]
        for l in range(1, x_int_nodes+1):
            B[0] = T_x0
            B[y_int_nodes+1] = T_xLy_arr[i]
